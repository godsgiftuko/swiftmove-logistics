...
import { assignOnlyDriver, checkDriverAvailability } from "../middlewares/delivery.middleware";
...
router.put("/:id/assign", restrictTo(['admin', 'agent']), expressValidate(validateAssignDriver), checkDriverAvailability, assignOnlyDriver, DeliveryController.assignDriver);
